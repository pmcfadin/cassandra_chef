...
where <role> is the value declared as default[:setup][:current_role]. Edit the file to look very similar to this:
...

    {
      ...
      "chef_type": "role",
      "override_attributes": {
        "cassandra": { "current_role": "cassandra07", "deployment": "07x", "tag": "cassandra-0.7.8", "ycsb_tag": "cassandra-0.7", "ycsb_package": "CassandraClient7" }
      }
    }

    {
      ...
      "chef_type": "role",
      "override_attributes": {
        "setup": { "deployment": "07x", "current_role": "cassandra07" }
      }
    }

    {
      ...
      "chef_type": "role",
      "override_attributes": {
        "setup": { "deployment": "08x", "current_role": "cassandra08" }
      }
    }
